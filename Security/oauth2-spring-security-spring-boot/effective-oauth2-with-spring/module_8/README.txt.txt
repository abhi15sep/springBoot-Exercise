...
- An instance of a keycloak server runnning, with a user created. I have included realm-export file to setup
the keycloak realm if you do not wish to configure it manually by following the modules, this will set everything up for you.
...
- Also ensure the roles mapper, and portfolio and support service audience mappers are created for the react client.
***********************
Trouble shooting
***********************
